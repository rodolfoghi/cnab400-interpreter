        ...
        this.linhas.forEach(function(linha) {
            ...
            switch (tipoDeRegistro) {
                case REGISTRO_HEADER:
                    ...
                    this.header.campos.push(new Campo("Identificação do Registro Header", linha.substring(0, 1)));
                    this.header.campos.push(new Campo("Tipo de Operação", linha.substring(1, 2)));
                    this.header.campos.push(new Campo("Identificação Tipo de Operação", linha.substring(2, 9)));
                    this.header.campos.push(new Campo("Identificação do Tipo de Serviço", linha.substring(9, 11)));
                    this.header.campos.push(new Campo("Identificação por Extenso do Tipo de Serviço", linha.substring(11, 19)));
                    this.header.campos.push(new Campo("Complemento do Registro", linha.substring(19, 26)));
                    this.header.campos.push(new Campo("Prefixo da Agência", linha.substring(26, 30)));
                    this.header.campos.push(new Campo("Dígito Verificador - D.V. - do Prefixo da Agência", linha.substring(30, 31)));
                    this.header.campos.push(new Campo("Número da Conta Corrente", linha.substring(31, 39)));
                    this.header.campos.push(new Campo("Dígito Verificador - D.V. - da Conta Corrente do Cedente", linha.substring(39, 40)));
                    this.header.campos.push(new Campo("Zeros", linha.substring(30, 46)));
                    this.header.campos.push(new Campo("Nome do Cedente", linha.substring(46, 76)));
                    this.header.campos.push(new Campo("001BANCODOBRASIL", linha.substring(76, 94)));
                    this.header.campos.push(new Campo("Data da Gravação", linha.substring(94, 100)));
                    this.header.campos.push(new Campo("Seqüencial do Retorno", linha.substring(100, 107)));
                    this.header.campos.push(new Campo("Complemento do Registro: “Brancos”", linha.substring(107, 149)));
                    this.header.campos.push(new Campo("Número de convênio", linha.substring(149, 156)));
                    this.header.campos.push(new Campo("Complemento do Registro: “Brancos”", linha.substring(156, 394)));
